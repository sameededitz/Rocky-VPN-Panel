@section('title', 'Add Sub-Sub Server')
        ...
        <div class="breadcrumb-wrapper-content d-flex justify-content-end">
            <nav class="breadcrumb-style-three" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('sub-sub-servers', $subServer->id) }}" class="d-flex align-items-center">Sub
                            Servers</a>
                    </li>
        ...
        <div class="col-xl-6 col-lg-8 col-md-10 col-sm-12 layout-spacing">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Add Sub-Sub Server</h5>
                </div>
                <div class="card-body">
